...
class AgentResponse(BaseModel):
    ...
    data_type: str | None = Field(
        None, description="Type of data returned (sheet, search, summary, etc.)"
    )
    ...
    search_results: list[SearchResult] | None = Field(
        None, description="Search results if applicable"
    )
    rows: list[RowData] | None = Field(None, description="Row data if applicable")
    status_breakdown: StatusBreakdown | None = Field(
        None, description="Status breakdown if applicable"
    )
